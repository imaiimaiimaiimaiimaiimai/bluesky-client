export default () => ({
  ...
  "official": "公式",
  "posts": "ポスト",
  "postWithReplies": "投稿と返信",
  "postWithMedia": "メディア付き投稿",
  "postWithVideo": "動画付き投稿",
  "postContent": "投稿",
  "reload": "再読み込み",
  "refresh": "更新する",
  "loading": "読込中...",
  ...
  "labelerOverLimit": "登録済みのラベラーが上限値に達していて、このラベラーを登録できません。",
